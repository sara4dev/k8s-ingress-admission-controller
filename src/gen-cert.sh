...
CN_BASE="generic_webhook_admission"
...
openssl req -new -key serverKey.pem -out server.csr -subj "/CN=k8s-ingress-admission-controller.kube-system.svc" -config server.conf
